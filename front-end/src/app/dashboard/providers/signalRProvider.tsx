...
export default function SignalRProvider({
    ...
    function CurrentlyLockedCards(data: any) {
        ...
        if (validData.success) {
            UpdateCurrentCardLockStateOfAllCardsFromSignalR(validData.data); 
        } else {
    ...
    function UsersMembershipChnaged(data: any) {
        const validData = UsersMembershipChnagedListSchema.safeParse(data); 
