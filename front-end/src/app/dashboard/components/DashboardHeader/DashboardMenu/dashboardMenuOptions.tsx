        ...
        <HoverOptionsPanel title='Menu' onCloseClick={() => setActivePanel('none')} offsetZeroTo='right'>
            <div className={styles.optionsList}>
                ...
                <button 
                    ...
                    <svg height="50" width="50" viewBox="0 0 800 800" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" 
                ...
                <button
                    ...
                    <svg width="20" height="20" viewBox="0 0 240 240" fill="none" stroke="#000" strokeWidth="20" strokeLinecap="round" strokeLinejoin="round">
                ...
                <button disabled={buttonDisabled} className={styles.logoutButton} onClick={handleLogout}>
                    <svg width="50" height="50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 150 150" fill="none">
                        <g fill="#000000">
