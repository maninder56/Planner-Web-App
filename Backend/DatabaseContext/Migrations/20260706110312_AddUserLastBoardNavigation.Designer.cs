...
namespace DatabaseContext.Migrations
{
    ...
    [Migration("20260706110312_AddUserLastBoardNavigation")]
    partial class AddUserLastBoardNavigation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DatabaseContext.Invitation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DatabaseContext.Invitation", b =>
                {
                    ...
                    b.HasOne("DatabaseContext.User", "InvitedByUser")
                        .WithMany("InvitationsSent")
                        .HasForeignKey("InvitedByUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DatabaseContext.User", "InvitedUser")
            ...
            modelBuilder.Entity("DatabaseContext.User", b =>
                {
                    b.HasOne("DatabaseContext.Board", "LastBoard")
                        .WithMany()
            ...
            modelBuilder.Entity("DatabaseContext.User", b =>
                {
                    ...
                    b.Navigation("InvitationsRecieved");
